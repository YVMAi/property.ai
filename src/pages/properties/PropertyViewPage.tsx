...
import { ArrowLeft, MapPin, Edit, Building2, DollarSign, FileText, Users, ChevronDown } from 'lucide-react';
...
export default function PropertyViewPage() {
  ...
  const { getPropertyById, changeStatus } = usePropertiesContext();
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-foreground">{property.address.street}</h1>
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-base font-medium">
              {property.type === 'student_housing' ? 'Beds' : 'Units'} ({property.units.length})
            </CardTitle>
          </CardHeader>
          <CardContent>
