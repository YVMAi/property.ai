    ...
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-muted/30">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          {/* Top Bar — sticky */}
          <header className="sticky top-0 z-30 h-14 bg-background border-b border-border flex items-center justify-between px-4 sm:px-6 shrink-0">
            <div className="flex flex-col justify-center">
              <span className="text-sm font-semibold text-foreground leading-tight">Welcome back, Tenant</span>
              <span className="text-xs text-muted-foreground leading-tight">Here's an overview of your lease & payments</span>
            </div>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="relative h-9 w-9">
                    ...
                    <span className="absolute top-1 right-1 flex items-center justify-center h-4 w-4 rounded-full bg-destructive text-[10px] font-bold text-destructive-foreground">3</span>
                  </Button>
                </DropdownMenuTrigger>
