...
const MOCK_OWNERS: Owner[] = [
  {
    ...
    agreements: [
      { id: 'ag1', name: 'Global Management Agreement 2026', fileName: 'Global_Agreement_2026.pdf', fileUrl: '#', startDate: '2026-01-01', endDate: '2026-12-31', managementFeeType: 'combination' as const, managementFeeFixed: 50, managementFeePercent: 8, leaseFeeType: 'fixed' as const, leaseFeeValue: 500, renewalFeeType: 'variable' as const, renewalFeeValue: 3, feePerUnit: 50, feePercentRent: 8, createdAt: '2026-01-01T00:00:00Z' },
    ],
